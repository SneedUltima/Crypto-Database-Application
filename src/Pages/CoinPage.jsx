    ...
    <div className="rounded-div my-12 py-8 text-white bg-crypto-purple-light">
      <div className="flex py-8 items-center">
        ...
        <div>
          ...
          <p>({coin?.symbol?.toUpperCase()} / AUD)</p>
        </div>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-8">
        <div>
          ...
          <div className="flex justify-between py-4">
            ...
            <div>
              <p className=" text-gray-300 text-sm">Volume (24hr)</p>
              {coin.market_data?.total_volume ? (
                <p>${coin.market_data.total_volume.aud.toLocaleString()}</p>
              ) : null}
            </div>
          </div>
        ...
        <div>
          ...
          <div className="flex justify-between py-4">
            <div>
              <p className=" text-gray-300 text-sm">Price Change (24hr)</p>
              {coin.market_data ? (
                <p>
